...
theorem expanded_role_is_relation
    ...
    o.role = .presentation ∨ o.role = .translation ∨ o.role = .closure := by
  cases o with
...
/--
The three UI transformations are closure transitions, rather than camera
actions.  The selected trace is retained by every transition.
-/
