...
| `GodelTarskiRelativeClosureBoundary.lean` | Bounded diagonal, selected closure theory, liar, and capacity boundary | The finite language, selected closure, liar diagonal, and capacity predicate are supplied; it does not formalize or supersede Gödel, Tarski, or Chaitin. |
